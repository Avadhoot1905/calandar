  ...
  return (
    <div>
      <div className="max-w-6xl mx-auto flex justify-center">
        <NavBar className={`fixed top-0 transition-all duration-300 ${scrolled ? "bg-white/80 backdrop-blur-md shadow-md rounded-xl p-2" : "bg-transparent"}`} />
      </div>
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 mt-2">Effortless scheduling for individuals, powerful solutions for fast-growing modern companies.</p>
        </div>
        ...
        <div className="max-w-4xl mx-auto flex justify-center gap-6 mt-8 px-6">
          <Card className="w-1/3 p-6 bg-white shadow-md rounded-lg text-center">
            ...
            <p className="text-gray-600 mt-2">We'll handle all the cross-referencing, so you don't have to worry about double bookings.</p>
          </Card>

          <Card className="w-1/3 p-6 bg-white shadow-md rounded-lg text-center">
            <span className="text-gray-500 text-sm font-bold">02</span>
            <h3 className="text-xl font-semibold mt-2">Set your availability</h3>
            <p className="text-gray-600 mt-2">Want to block off weekends? Set up any buffers? We make that easy.</p>
          </Card>

          <Card className="w-1/3 p-6 bg-white shadow-md rounded-lg text-center">
            <span className="text-gray-500 text-sm font-bold">03</span>
            <h3 className="text-xl font-semibold mt-2">Choose how to meet</h3>
            <p className="text-gray-600 mt-2">It could be a video chat, phone call, or a walk in the park!</p>
          </Card>
        </div>
      </div>
    </div>
