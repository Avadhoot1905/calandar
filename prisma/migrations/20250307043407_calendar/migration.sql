...
-- CreateIndex
CREATE UNIQUE INDEX "EventTag_eventId_userId_key" ON "EventTag"("eventId", "userId");
...
-- AddForeignKey
ALTER TABLE "EventTag" ADD CONSTRAINT "EventTag_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
